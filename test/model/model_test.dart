...
void main() {
  var entry1 = NumberEntry(3, new DateTime(2018, 7, 1, 13, 29, 0), 'Worked on journal app');
  var entry2 = NumberEntry(1, new DateTime(2018, 7, 1, 19, 15, 0), 'Worked on journal app');
  ...
  //   expect(day1.time, equals(deser.time));
  ...
  //   expect(day1.entries[0].time, equals(deser.entries[0].time));
  //   expect(day1.entries[1].value, equals(deser.entries[1].value));
  //   expect(day1.entries[1].time, equals(deser.entries[1].time));
  // });
